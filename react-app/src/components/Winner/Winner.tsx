...
const Winner = ({ name, question }: WinnerProps) => {
  ...
  return (
    <div className="relative flex flex-col items-center w-[160px] h-[95px] sm:w-[360px] sm:h-[200px]">
      {/* 상단 이미지 */}
      ...
      {/* 내용 박스 */}
      <div className="mt-[40px] sm:mt-[80px] w-full h-24 sm:h-36 bg-white rounded-xl shadow-xl flex flex-col items-center justify-center pt-[33px] sm:pt-[35px] pb-4 sm:pb-3 sm:px-2">
