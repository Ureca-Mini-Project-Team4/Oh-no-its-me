      ...
      {isMobile ? (
        <div className="">
          ...
          <div className="flex justify-between items-center w-full p-5">
            ...
            <Button label="이후" onClick={handleNext} size="sm"></Button>
          </div>
        </div>
      ) : (
        <div className="p-5">
          <div className="flex flex-col bg-gray-50 p-5 rounded-[30px] sm:flex-row">
            <div className="p-20">
              <div className="flex flex-col items-center justify-center gap-10 font-ps text-sm text-center sm:text-3xl">
                <p>무인도에서 가장 탈출 못할 것 같은 사람은?</p>
